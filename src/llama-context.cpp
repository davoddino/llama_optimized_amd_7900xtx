...
static bool qwen36_mega_no_raw_logits_enabled() {
    return qwen36_superlayer_final_enabled() ||
        qwen36_env_enabled("GGML_CUDA_RDNA3_QWEN36_MEGA_NO_RAW_LOGITS");
}

static bool qwen36_mega_sample_token_only_enabled() {
    return qwen36_superlayer_final_enabled() ||
        qwen36_env_enabled("GGML_CUDA_RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY");
}
