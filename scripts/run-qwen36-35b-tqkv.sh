...
RDNA3_QWEN36_MEGA_REQUIRE_GRAPH="${RDNA3_QWEN36_MEGA_REQUIRE_GRAPH:-0}"
RDNA3_QWEN36_MEGA_GRAPH_GRACE_EVALS="${RDNA3_QWEN36_MEGA_GRAPH_GRACE_EVALS:-8}"
RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY="${RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY:-0}"
RDNA3_QWEN36_MEGA_NO_RAW_LOGITS="${RDNA3_QWEN36_MEGA_NO_RAW_LOGITS:-0}"
RDNA3_QWEN36_MEGA_ASYNC_INPUTS="${RDNA3_QWEN36_MEGA_ASYNC_INPUTS:-0}"
...
RDNA3_QWEN36_ONE_LAYER_MEGA_WAS_SET=0
if [[ -n "${RDNA3_QWEN36_ONE_LAYER_MEGA+x}" ]]; then
    RDNA3_QWEN36_ONE_LAYER_MEGA_WAS_SET=1
fi
RDNA3_QWEN36_ONE_LAYER_MEGA="${RDNA3_QWEN36_ONE_LAYER_MEGA:-0}"
RDNA3_QWEN36_ONE_LAYER_MEGA_LAYER="${RDNA3_QWEN36_ONE_LAYER_MEGA_LAYER:-0}"
RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED="${RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED:-}"
RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY_WAS_SET=0
if [[ -n "${RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY+x}" ]]; then
    RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY_WAS_SET=1
fi
RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY="${RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY:-0}"
...
RDNA3_MMVQ_Q8_CACHE_LOG="${RDNA3_MMVQ_Q8_CACHE_LOG:-0}"
...
case "$RDNA3_KERNEL_PRESET" in
    ...
    mega-contract)
        RDNA3_TQKV_FATTN_KQ_LANES="${RDNA3_TQKV_FATTN_KQ_LANES:-4}"
        RDNA3_GDN_AR_COLS="${RDNA3_GDN_AR_COLS:-8}"
        RDNA3_MOE_MMVQ_RPB="${RDNA3_MOE_MMVQ_RPB:-8}"
        RDNA3_MOE_DOWN_RPB="${RDNA3_MOE_DOWN_RPB:-8}"
        RDNA3_MOE_GATE_UP_RPB="${RDNA3_MOE_GATE_UP_RPB:-4}"
        RDNA3_QWEN36_MEGA_DECODE=1
        RDNA3_QWEN36_MEGA_REQUIRED=1
        RDNA3_QWEN36_MEGA_REQUIRE_GRAPH=1
        RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY=1
        RDNA3_QWEN36_MEGA_NO_RAW_LOGITS=1
        RDNA3_QWEN36_MEGA_ASYNC_INPUTS=1
        if [[ "$RDNA3_QWEN36_ONE_LAYER_MEGA_WAS_SET" == "0" ]]; then
            RDNA3_QWEN36_ONE_LAYER_MEGA=1
        fi
        if [[ "$RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY_WAS_SET" == "0" ]]; then
            RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY=1
        fi
        BACKEND_SAMPLING=1
        SAMPLING_TOP_K=20
        SAMPLING_TOP_P=1
        SAMPLING_MIN_P=0
        SAMPLERS="${SAMPLERS:-top_k;temperature}"
        ;;
    *)
...
if [[ -z "$RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED" ]]; then
    RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED="$RDNA3_QWEN36_ONE_LAYER_MEGA"
fi
...
if [[ "$RDNA3_QWEN36_MEGA_REQUIRE_GRAPH" == "1" ]]; then
    export GGML_CUDA_RDNA3_QWEN36_MEGA_REQUIRE_GRAPH=1
    export GGML_CUDA_RDNA3_QWEN36_MEGA_GRAPH_GRACE_EVALS="$RDNA3_QWEN36_MEGA_GRAPH_GRACE_EVALS"
fi

if [[ "$RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY" == "1" ]]; then
    export GGML_CUDA_RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY=1
fi

if [[ "$RDNA3_QWEN36_MEGA_NO_RAW_LOGITS" == "1" ]]; then
    export GGML_CUDA_RDNA3_QWEN36_MEGA_NO_RAW_LOGITS=1
fi

if [[ "$RDNA3_QWEN36_MEGA_ASYNC_INPUTS" == "1" ]]; then
...
if [[ "$RDNA3_QWEN36_ONE_LAYER_MEGA" == "1" ]]; then
    export GGML_CUDA_RDNA3_QWEN36_ONE_LAYER_MEGA=1
    export GGML_CUDA_RDNA3_QWEN36_ONE_LAYER_MEGA_LAYER="$RDNA3_QWEN36_ONE_LAYER_MEGA_LAYER"
fi

if [[ "$RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED" == "1" ]]; then
    export GGML_CUDA_RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED=1
fi

if [[ "$RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY" == "1" ]]; then
    export GGML_CUDA_RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY=1
fi
...
if [[ "$RDNA3_MMVQ_Q8_CACHE_LOG" == "1" ]]; then
    export GGML_CUDA_RDNA3_MMVQ_Q8_CACHE_LOG=1
fi
...
echo "  rdna3 qwen36 mega require graph: $RDNA3_QWEN36_MEGA_REQUIRE_GRAPH"
echo "  rdna3 qwen36 mega graph grace evals: $RDNA3_QWEN36_MEGA_GRAPH_GRACE_EVALS"
echo "  rdna3 qwen36 mega sample token only: $RDNA3_QWEN36_MEGA_SAMPLE_TOKEN_ONLY"
echo "  rdna3 qwen36 mega no raw logits: $RDNA3_QWEN36_MEGA_NO_RAW_LOGITS"
echo "  rdna3 qwen36 mega async inputs: $RDNA3_QWEN36_MEGA_ASYNC_INPUTS"
...
echo "  rdna3 qwen36 one-layer mega: $RDNA3_QWEN36_ONE_LAYER_MEGA"
echo "  rdna3 qwen36 one-layer mega layer: $RDNA3_QWEN36_ONE_LAYER_MEGA_LAYER"
echo "  rdna3 qwen36 one-layer mega required: $RDNA3_QWEN36_ONE_LAYER_MEGA_REQUIRED"
echo "  rdna3 qwen36 one-layer mega identity: $RDNA3_QWEN36_ONE_LAYER_MEGA_IDENTITY"
...
echo "  rdna3 mmvq q8 cache log: $RDNA3_MMVQ_Q8_CACHE_LOG"
